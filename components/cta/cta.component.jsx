  ...
  return (
    <div className={styles.container}>
      <div className={styles.inner_box}>
        ...
        <p className={styles.parapgraph}>&#10095; &emsp; PAINTINGS</p>
        <p className={styles.parapgraph}>&#10095; &emsp; DRAWINGS</p>
        <p className={styles.parapgraph}>&#10095; &emsp; EXHIBITION</p>
        <p className={styles.parapgraph}>&#10095; &emsp; BLOG</p>
        <p className={styles.parapgraph}>&#10095; &emsp; CONTACT</p>
      </div>
      <div className={styles.inner_box}>
      ...
      <div className={styles.inner_box}>
        ...
        <p className={styles.parapgraph}>&#10095; &emsp;Original Paintings</p>
        <p className={styles.parapgraph}>&#10095; &emsp;Drawings</p>
        <p className={styles.parapgraph}>&#10095; &emsp;Prints</p>
      </div>
    </div>
  );
};
